...
async function seedScholarships() {
    try {
        ...
        // Check if existing data needs update (missing metadata or broken/unwanted images)
        const sample = await scholarshipsCollection.findOne();
        const brokenIds = [
            "photo-1523050854058-8df90110c9f1",
            "photo-1541339907198-e08756ebafe1",
            "photo-1521587760476-6c12a7104b6b",
            "photo-1523580494863-6f3031224c94" // the ceremony one
        ];

        const unwantedSample = await scholarshipsCollection.findOne({
            image: {
                $regex: brokenIds.join('|')
            }
        });
        ...
        if (count === 0 || needsUpdate) {
            if (needsUpdate) {
                console.log('🔄 Detected missing metadata or broken/unwanted images. Clearing to re-seed...');
            ...
            const addUnis = (category, subCategory, unis, studyLevel, fundingType, benefits = {}, hsk = "None", ielts = "None") => {
                unis.forEach(uni => {
                    scholarships.push({
                        ...
                        image: uni.image || "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=800&auto=format&fit=crop", // Verified academic default
            ...
            addUnis("Short-Term Program", "哈尔滨青年冰雪创新体验营 Harbin Youth Ice Innovation Experience Camp", [
                { name: "Harbin Engineering University", location: "Harbin", image: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=800&auto=format&fit=crop" },
                { name: "Harbin Institute of Technology", location: "Harbin", image: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=80&w=800&auto=format&fit=crop" }
            ], "Chinese Language", "Scholarship", tuitionHostel);

            addUnis("Chinese Government Scholarship", "中国政府奖学金 Chinese Government Scholarship", [
                { name: "Zhejiang University", location: "Hangzhou", image: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=800&auto=format&fit=crop" },
            ...
            addUnis("Bachelor's Degree Program", "Engineering Studies", [
                { name: "Tsinghua University", location: "Beijing", image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=800&auto=format&fit=crop" },
                { name: "Peking University", location: "Beijing", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=800&auto=format&fit=crop" }
            ...
            addUnis("Self-funded Undergraduate Program", "Bachelor of Business", [
                ...
                { name: "Sun Yat-sen University", location: "Guangzhou", image: "https://images.unsplash.com/photo-1531058240602-04b060d37f41?q=80&w=800&auto=format&fit=crop" }
